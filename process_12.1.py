...
def data_preprocessing(stock_name):
    ...
    def preprocessing():
        ...
        merged_df = merged_df.drop(columns=['added_date', 'Open (Rs.)','High (Rs.)','Low (Rs.)','ShareVolume','Turnover (Rs.)'],axis=1)
...
def model_building(stock_name):
    ...
    X = df.drop(columns=['positive_sentiment', 'negative_sentiment', 'neutral_sentiment','added_date', 'Daily Return', 'Close (Rs.)','RSI_quantile', 'MACD_quantile', 'ATR_quantile', 'SMA_10_quantile', 'EMA_10_quantile', 'OBV_quantile',
