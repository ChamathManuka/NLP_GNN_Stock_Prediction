...
#----------------------------------------------------------------------------------------------------------------
        ...
        print(df2)
        filtered_df.to_csv('stock_price_files/processed_price_files/'+stock+'_stock_data_with_returns.csv', index=False)
    ...
    def merge_daily_returns():
        ...
        merged_df.to_pickle("process_11_files/list_files/_merged_data_with_daily_return_test.pkl")
...
def prediction(stock_name):
    df = pd.read_pickle("process_11_files/list_files/_merged_data_with_daily_return_test.pkl")
    ...
    loaded_model = load_model("process_11_files/model_files/"+stock_name+"_sequential.h5")
