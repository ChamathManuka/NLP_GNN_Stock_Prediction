...
output_file1 = os.path.join("../stock_outputs", stock_name + "2024_09_30_5K_ALL_test1.csv")
output_file2 = os.path.join("../stock_outputs", stock_name + "2024_09_30_5K_ALL_test2.csv")
...
# Example usage:
merge_two_column_csvs("stock_outputs/"+ stock_name + "2024_09_30_5K_ALL_test1.csv", "stock_outputs/"+ stock_name + "2024_09_30_5K_ALL_test2.csv", "stock_outputs/"+ stock_name + "_merged_output_all.csv")