...
def model_building(stock_name):
    ...
    X = df.drop(columns=['added_date', 'positive_sentiment', 'negative_sentiment', 'neutral_sentiment', 'Daily Return',
    ...
    tuner = kt.RandomSearch(build_model, objective='val_loss', max_trials=10, executions_per_trial=2,
                            directory='E:\Academic\master\master\parameter_tuning',
                            project_name='model_tuning_' + stock_name + '_2')
