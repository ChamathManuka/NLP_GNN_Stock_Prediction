...
def data_preprocessing():
    ...
    def tfidf_calculation(documents, dataframe):
        ...
        joblib.dump(tfidf_vectorizer, "../process_15_files/model_files/tfidf_vectorizer.pkl")
        joblib.dump(tfidf_matrix, "../process_15_files/model_files/tfidf_matrix.pkl")
    ...
    def preprocessing():
        ...
        # model.save("process_15_files/model_files/doc2vec_model.model")
        df_grouped.to_pickle("process_15_files/list_files/document_vectors.pkl")
...
def stock_data_preprocessing(stock_name):
    ...
    def merge_daily_returns():
        df1 = pd.read_pickle("../process_15_files/list_files/document_vectors.pkl")
        ...
        merged_df.to_pickle("process_15_files/list_files/" + stock_name + "_merged_data_with_daily_return.pkl")
...
def model_building_1(stock_name):
    df = pd.read_pickle("process_15_files/list_files/" + stock_name + "_merged_data_with_daily_return.pkl")
    ...
    model.save("process_15_files/model_files/" + stock_name + "_sequential.h5")
    # Make predictions
