...
def parameter_tuning(stock_name):
    ...
    tuner = kt.RandomSearch(build_model, objective='val_loss', max_trials=10, executions_per_trial=2,
                            ...
                            project_name='mpl_tuning_' + stock_name + '_3')
    tuner.search(X_train_scaled, y_train_scaled, epochs=40, batch_size=8,
...
def model_building(stock_name):
    ...
    # Train the model
    history = model.fit(X_train_scaled, y_train_scaled, epochs=400, batch_size=32, verbose=1,
                        validation_data=(X_test_scaled, y_test_scaled))
