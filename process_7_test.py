...
def data_cleaning():
    ...
    df_grouped.to_csv("process_7.1_files/csv_files/test_june_to_sept_processed.csv", index=False)
...
def stock_data_preprocessing(stock_name):
    ...
    def merge_daily_returns():
        ...
        df1 = pd.read_csv("process_7.1_files/csv_files/test_june_to_sept_processed.csv")
...
def sentiment_vectorization(stock_name):
    ...
    def create_model_data(stock_name):
        ...
        with open('process_7.1_files/list_files/' + stock_name + '_test_june_to_sept_vectorized.pkl', 'wb') as f:
...
def make_prediction(stock_name):
    ...
    df_new.to_csv('process_7.1_files/prediction_files/' + stock_name + '_test_june_to_sept_predicted.csv')
#--------------------------------------------------------------------------------------------------------
def prediction_graph(stock_name):

    # Load the CSV file
    df = pd.read_csv('process_7.1_files/prediction_files/' + stock_name + '_test_june_to_sept_predicted.csv')
...
def business_date_selection_graph(stock_name):
    ...
    df.to_csv('process_7.1_files/csv_files/'+stock_name+'_test_june_to_sept_predicted_business_dates.csv', index=False)
